...
// ----------------------------------------------------------------------------
// $Id: Haval.java,v 1.2 2005/05/18 04:14:33 exelnet Exp $
//
 ...
 * variable number of rounds. By default, this implementation allows <i>HAVAL
 * </i> to be used as a drop-in replacement for <i>MD5 </i>.
 * </p>
 * 
 * <p>
 * References:
...
public class Haval extends BaseHash {
	...
	/**
	 * <p>
	 * Constructs a <code>Haval</code> instance with the designated output
	 * size (in bytes). Valid output <code>size</code> values are
	 * <code>16</code>,<code>20</code>,<code>24</code>,
	 * <code>28</code> and <code>32</code>. Valid values for
	 * <code>rounds</code> are in the range <code>3..5</code> inclusive.
	 * </p>
	 * 
	 * @param size
	 *            the output size in bytes of this instance.
	...
	public boolean selfTest() {
		if (valid == null) {
			valid = new Boolean(DIGEST0.equals(Util.toString(new Haval()
					.digest())));
		}
