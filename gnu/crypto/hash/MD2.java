...
// ----------------------------------------------------------------------------
// $Id: MD2.java,v 1.2 2005/05/18 04:14:33 exelnet Exp $
//
...
public class MD2 extends BaseHash {
	...
	public boolean selfTest() {
		if (valid == null) {
			valid = new Boolean(DIGEST0.equals(Util
	 ...
	 * <code>i</code> bytes of value <code>i</code>, where <code>i</code>
	 * is the number of bytes to fill the last block of the message to
	 * <code>BLOCK_LENGTH</code> bytes (or <code>BLOCK_LENGTH</code> bytes
	 * when the last block was completely full).
	 * </p>
	 * 
	 ...
	 */
	/**
	 * Adds a new block (<code>BLOCK_LENGTH</code> bytes) to the running
	 * digest from the given byte array starting from the given offset.
	 */
