...
// ----------------------------------------------------------------------------
// $Id: Whirlpool.java,v 1.2 2005/05/18 04:14:33 exelnet Exp $
//
 ...
 * 256 bits in length. The function structure is designed according to the Wide
 * Trail strategy and permits a wide variety of implementation trade-offs.
 * </p>
 * 
 * <p>
 ...
 * <ol>
 * <li><a
 * href="http://planeta.terra.com.br/informatica/paulobarreto/WhirlpoolPage.html">
...
public final class Whirlpool extends BaseHash {
	...
	static {
		...
		if (DEBUG && debuglevel > 8) {
			...
			for (i = 0; i < 64; i++) {
				for (j = 0; j < 4; j++) {
					System.out
							.print("0x" + Util.toString(T0[i * 4 + j]) + ", ");
				}
				System.out.println();
			}
			System.out.println();
	...
	public boolean selfTest() {
		if (valid == null) {
			valid = new Boolean(DIGEST0.equals(Util.toString(new Whirlpool()
					.digest())));
		}
