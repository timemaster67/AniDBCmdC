...
public class Crc16 extends AbstractChecksum {
	...
	protected final int crc16tab[] = { 0x0000, 0xC0C1, 0xC181, 0x0140, 0xC301,
	 ...
	 * 
	 * x^16 + x^15 + x^2 + 1 = 1 1000 0000 0000 0101 = 18005 ^ implicit value
	 * (17th bit)
	 * 
	 * Inverting the bit order yields = 1010 0000 0000 0001 1 = A0011 ^ implicit
	 * value (17th bit)
	 *  => parameter for method buildTable is 0xA001.
	 */

	/*
	 * The following source build values for the CRC-16 lookup table, because it
	 * is much faster to look in a precompiled table!
	 * 
	 * 
	 * public static final int[] buildTable(int poly) { int[] table = new
	 * int[256]; int crc,i,k; for (i=0; i < 256; i++) { crc = i; for (k=0; k <
	 * 8; k++) { crc = ((crc & 1) > 0) ? (crc >>> 1) ^ poly : crc >>> 1; }
	 * table[i] = crc; } return table; }
	 * 
	 * 
	 * public static void main(String[] args) throws Exception {
	 * 
	 * int[] table = buildTable(0xA001); int len=256; int i=0; while (--len >=
	 * 0) {
